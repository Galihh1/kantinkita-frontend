...
const NAV_ITEMS = [
  ...
  { path: '/admin/subscriptions',  label: 'Langganan',          icon: CreditCardIcon,         permission: 'read-sistem', badgeKey: 'pending-subscriptions' },
  ...
  { path: '/admin/errors',         label: 'Error Monitor',      icon: ExclamationTriangleIcon, permission: 'read-sistem', badgeKey: 'open-errors' },
